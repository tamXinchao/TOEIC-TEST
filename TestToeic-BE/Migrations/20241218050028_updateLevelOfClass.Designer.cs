...
namespace TestToeic.Migrations
{
    ...
    [Migration("20241218050028_updateLevelOfClass")]
    partial class updateLevelOfClass
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TestToeic.entity.Class", b =>
                {
                    ...
                    b.Property<int?>("LevelOfClassId")
                        .HasColumnType("integer");

                    b.HasKey("ClassId");

                    b.HasIndex("LevelOfClassId");

                    b.ToTable("Classes");
                });

            modelBuilder.Entity("TestToeic.entity.LevelOfClass", b =>
                {
                    b.Property<int>("LevelOfClassId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("LevelOfClassId"));
                    ...
                    b.HasKey("LevelOfClassId");

                    b.ToTable("LevelOfClasses");
                });
            ...
            modelBuilder.Entity("TestToeic.entity.Class", b =>
                {
                    b.HasOne("TestToeic.entity.LevelOfClass", "LevelOfClasses")
                        .WithMany("Classes")
                        .HasForeignKey("LevelOfClassId");

                    b.Navigation("LevelOfClasses");
                });
