...
namespace TestToeic.Migrations
{
    ...
    [Migration("20241106152520_update6.11v2")]
    partial class update611v2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TestToeic.entity.AnswerOfStudent", b =>
                {
                    ...
                    b.Property<int?>("StudentPointStudentAnswerId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("StudentPointStudentAnswerId");
            ...
            modelBuilder.Entity("TestToeic.entity.AnswerOfStudent", b =>
                {
                    ...
                    b.HasOne("TestToeic.entity.StudentPoint", null)
                        .WithMany("AnswerOfStudents")
                        .HasForeignKey("StudentPointStudentAnswerId");
